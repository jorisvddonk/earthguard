function PIDController(kp, ki, kd, minIntegral, maxIntegral, minCapIntegral, maxCapIntegral) {
  var self = this;
  ...
  self.step = function step() {
      ...
      if (self.minCapIntegral !== undefined && self.minCapIntegral !== null && self.integralError < self.minCapIntegral) {
        self.integralError = self.minCapIntegral;
      }
      if (self.maxCapIntegral !== undefined && self.maxCapIntegral !== null && self.integralError > self.maxCapIntegral) {
      ...
      if (self.minIntegral !== undefined && self.minIntegral !== null && mI < self.minIntegral) {
        mI = self.minIntegral;
      }
      if (self.maxIntegral !== undefined && self.maxIntegral !== null && mI > self.maxIntegral) {
        mI = self.maxIntegral;
      }
