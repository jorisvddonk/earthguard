define('subsystem/fueltanks', ['shipSubsystem'], function(ShipSubsystem){
  ...
  FueltanksSubsystem.prototype.getFuelRemaining = function() {
    return _.reduce(this.fueltanks, function(memo, fueltank){ return memo + fueltank.content; }, 0);
  };

  FueltanksSubsystem.prototype.consumeFuel = function(amount) {
    var fuelTankToUse = _.find(this.fueltanks, function(fueltank){ return fueltank.content > amount; });
